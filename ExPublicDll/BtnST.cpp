/**************************************************************************************************
 Copyright (C), BEE, 2013. ALL Rights Reserved.
 File name:     BtnST.cpp
 Author:         
 Date:          
 Description:   CButtonST类，平面按钮，可以带有icon或者bitmap，可以透明，从网站获得
 History:       
13/11/6 - @1
- 创建文件
**************************************************************************************************/
...
// this file is copped from old project
...
DWORD CButtonST::OnDrawBorder(CDC* pDC, CRect* pRect)
{
	...
	else // ...else draw non pressed button
	{
		...
		if (m_bIsFlat)
		{
			if ((m_bMouseOnButton||m_bHighLighted) && m_bDrawBorder)
...
// 高亮显示按钮，和鼠标在按钮上一样
void CButtonST::SetHighLight(BOOL bHighLight, BOOL bRepaint)
{
